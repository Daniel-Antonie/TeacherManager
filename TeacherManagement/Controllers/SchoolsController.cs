...
namespace TeacherManagement.Controllers
{
    public class SchoolsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SchoolID,PrincipleName,SchoolName,SchoolAddress,Phone")] School school)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SchoolID,PrincipleName,SchoolName,SchoolAddress,Phone")] School school)
        {
